...
###################################
Nx   = 2560              # Number of gridpoints in X
...
perturb = 0.05                    # Perturbation of initial density
nx = 1.0 + perturb*np.cos(k*X)

for i in range(I1,I2+1):
    f1[i,J1:J2+1] = nx[i-I1]/np.sqrt(2.0*np.pi)*V**2.0 * np.exp(-0.5*V**2.0 )
